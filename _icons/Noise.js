...
var Noise = function (props) { return (react_1.default.createElement(Icon_1.default, __assign({}, props, { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24" }),
    react_1.default.createElement("path", { stroke: "currentColor", strokeMiterlimit: "10", strokeWidth: "1.5", d: "M1.358 11.412h4.897v6.823H1.358a.358.358 0 01-.358-.31V11.77a.358.358 0 01.358-.358v0z" }),
    react_1.default.createElement("path", { stroke: "currentColor", strokeMiterlimit: "10", strokeWidth: "1.5", d: "M12.566 7.153V22.64a.35.35 0 01-.57.28l-5.75-4.432v-7.288l5.75-4.336a.358.358 0 01.57.29v0z" }),
