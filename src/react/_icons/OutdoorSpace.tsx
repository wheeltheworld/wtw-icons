...
const OutdoorSpace: IconComponent = (props) => (
    ...
    <path d="M13.919,15.252A3.414,3.414,0,0,0,16,16c2.209,0,4-2.239,4-5a5.509,5.509,0,0,0-1.477-3.85A4.971,4.971,0,0,0,19,5c0-2.209-1.343-4-3-4a2.82,2.82,0,0,0-2.367,1.568" stroke="currentColor"></path>
