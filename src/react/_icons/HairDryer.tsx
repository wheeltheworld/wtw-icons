import React from 'react';
    ...
    const HairDryer: IconComponent = (props) => (
        <Icon viewBox="0 0 24 24" fill="undefined" {...props}>
            <g><path fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} d="M18.6,9c-2.4,0.4-4.8,1-6.2,1.3c-4.7,0.8-4.7,0.8-5.1,0.8l-1.2,0c-1.3,0-2.7-0.5-3.6-1.5C1.5,8.7,1,7.4,1,6.1 c0-1.5,0.7-2.9,1.8-3.8C4,1.2,5.5,0.8,7,1.1l11.6,2l3.7-1.2c0.2-0.1,0.4,0,0.5,0.1C22.9,2.1,23,2.3,23,2.4v7.2 c0,0.2-0.1,0.3-0.2,0.5c-0.1,0.1-0.2,0.1-0.3,0.1c-0.1,0-0.1,0-0.2,0L18.6,9z" /><path fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} d="M18.6,3.1V9" /><ellipse fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} cx={6.1} cy={6} rx={1.5} ry={1.5} /><path fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} d="M9.9,10.7l1.1,6.5c0.1,0.5-0.1,1.1-0.4,1.5c-0.4,0.4-0.9,0.7-1.4,0.7h0" /><path fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} d="M9.2,19.4c-0.9,0-1.7-0.7-1.8-1.6l-1.1-6.7" /><path fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit={10} d="M9.5,19.4c0,1,0.4,1.9,1.1,2.6c0.7,0.7,1.6,1.1,2.6,1.1c0,0,0,0,0,0c2,0,3.6-1.7,3.6-3.7l0-0.6v-1.8 c0-0.9,0.7-1.6,1.6-1.6S20,16,20,16.9V23" /></g>
        </Icon>
    );
