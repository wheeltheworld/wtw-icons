...
const Elevator: IconComponent = (props) => (
    <Icon viewBox="0 0 24 24" {...props}>
        <g
            ...
            stroke="currentColor"
        >
            <polygon points="18 10 24 10 21 6 18 10" data-cap="butt" data-stroke="none" stroke="none" />
            <polygon points="18 14 24 14 21 18 18 14" data-cap="butt" data-stroke="none" stroke="none" />
