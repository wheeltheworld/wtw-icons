...
const CurrencyExchange: IconComponent = (props) => (
    <Icon viewBox="0 0 24 24" {...props}>
        <g transform="translate(0.5, 0.5)" fill="currentColor">
            ...
            />
            <polygon
                points="21.35 21.35 17.5 21.9 18.05 18.05 21.35 21.35"
                fill="currentColor"
                data-cap="butt"
                data-stroke="none"
                strokeLinecap="round"
            />
            <polygon
                points="5.95 5.95 6.5 2.1 2.65 2.65 5.95 5.95"
                fill="currentColor"
                data-cap="butt"
                data-stroke="none"
                strokeLinecap="round"
            ...
            />
            <path
                d="M19.778,19.778A11,11,0,0,0,12,1"
                fill="none"
                stroke="currentColor"
                strokeMiterlimit="10"
                strokeWidth="1.5"
            ...
            />
            <path
                d="M4.222,4.222A11,11,0,0,0,12,23"
                fill="none"
                stroke="currentColor"
                strokeMiterlimit="10"
                strokeWidth="1.5"
